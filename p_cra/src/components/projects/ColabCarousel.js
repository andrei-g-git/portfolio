...
function ColabCarousel(props) {
    ...
    return (React.createElement("div", { className: "colab-container" }, React.createElement(ProjectSwiperJS_1["default"], { items: mapShowcaseItems(props.showcaseItems, 
        /* props. */ notifyParent, 
        // props.selectProject,
        // props.toggleModal,
        // props.showcaseItem,
...
var mapShowcaseItems = function (showcaseItems, notifyParent, /* curryNotifyParent: Function, selectProject: number, toggleModal: Function, */ props /* ShowcaseItem: JSX.Element, Overlay: JSX.Element */) {
    return showcaseItems.map(function (item) {
        return React.createElement(props.ShowcaseItem, { image: item.image, width: 300, height: 220, key: item.index },
